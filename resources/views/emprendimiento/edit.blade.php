...
<section>
  <div class="container">
          <p class="titulo">Editar emprendimiento</p>
          <form id="Form" action="/emprendimiento/{{$emprendimiento->id}}" method="POST" enctype="multipart/form-data" class = "needs-validation" novalidate>
              @csrf
              @method('PUT')
          <div class="container conteiner tamaño">
            <div class="mb-3">
              <label for="" class="form-label">Nombre</label>
              <input id="nombre" name="nombre" type="text" class="form-control  input " value="{{$emprendimiento->nombre}}" required>
              <div class = "valid-feedback">¡Campo completado!</div>
              <div class = "invalid-feedback">Campo obligatorio.</div>
            </div>
            <div class="mb-3">
              <label for="" class="form-label">Descripción</label>
              <input id="descripcion" name="descripcion" type="text" class="form-control  input " value="{{$emprendimiento->descripcion}}" required>
              <div class = "valid-feedback">¡Campo completado!</div>
              <div class = "invalid-feedback">Campo obligatorio.</div>
            </div>
            <div class="mb-3">
              <label for="" class="form-label">Localidad</label>
              <select id="localidad_id" name="localidad_id"  class="form-control  input " value="" required>
              <div class = "valid-feedback">¡Campo completado!</div>
              <div class = "invalid-feedback">Campo obligatorio.</div>      
            ...
            <div class="mb-3">
              ...
              <input id="direccion" name="direccion" type="text"  class="form-control  input " value="{{$emprendimiento->direccion}}" required>
              <div class = "valid-feedback">¡Campo completado!</div>
              <div class = "invalid-feedback">Campo obligatorio.</div>
            </div>
            <div class="mb-3">
              <label for="" class="form-label">Sitio Web</label>
              <input id="sitio_web" name="sitio_web" type="text"  class="form-control  input " value="{{$emprendimiento->sitio_web}}" required>
              <div class = "valid-feedback">¡Campo completado!</div>
              <div class = "invalid-feedback">Campo obligatorio.</div>
            </div>
            <div class="mb-3">
              <label for="" class="form-label">Instagram</label>
              <input id="instagram" name="instagram" type="text"  class="form-control  input " value="{{$emprendimiento->instagram}}" required>
              <div class = "valid-feedback">¡Campo completado!</div>
              <div class = "invalid-feedback">Campo obligatorio.</div>
            </div>
            <div class="mb-3">
              <label for="" class="form-label">Facebook</label>
              <input id="facebook" name="facebook" type="text"  class="form-control  input " value="{{$emprendimiento->facebook}}" required>
              <div class = "valid-feedback">¡Campo completado!</div>
              <div class = "invalid-feedback">Campo obligatorio.</div>
            </div>
            <div class="mb-3">
              <label for="" class="form-label">Teléfono</label>
              <input id="nro_telefono" name="nro_telefono" type="text"  class="form-control  input " value="{{$emprendimiento->nro_telefono}}" required>
              <div class = "valid-feedback">¡Campo completado!</div>
              <div class = "invalid-feedback">Campo obligatorio.</div>
            </div>
