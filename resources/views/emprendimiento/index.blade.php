...
<a href="emprendimiento/create" class="btn btn-primary ">Crear</a>
<br>
<p></p>
    <div class="container">
        <div class="row">
                    ...
                    <tbody>
                      ...
                      <tr>
                          ...
                          <form action="{{ route('emprendimiento.destroy',$emprendimiento->id) }}" method="POST">
                            <a href="/emprendimiento/{{$emprendimiento->id}}/edit"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-fill" viewBox="0 0 16 16">
